    ...
    const exportToExcel = () => {
        ...
        if (!dni) {
            Swal.fire({
                icon: 'error',
                title: '¡Error!',
                text: 'Por favor, ingrese un DNI antes de exportar a Excel.'
            });
            return;
        }
        ...
        const filteredData = clinicalRecords.filter(record =>
            record.idmascota?.idcliente?.dni === parseInt(dni, 10)
        );
                ...
                <Formik
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant="primary" onClick={exportToExcel} style={{ background: '#56208c', borderColor: 'transparent' }}>Exportar a Excel</Button>
                        </Modal.Footer>
                    </Form>
                    )}
                    </Formik>
