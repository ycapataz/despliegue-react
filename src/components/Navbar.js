        ...
        <div className={styleNavL.sidebar}>
            <ul className={styleNavL.navUl}>
                <li className={styleNavL.navIl}>
                    <NavLink to='/inicio' exact className='px-1 w-100 d-inline-bock py-2' activeClassName="active"><FaIcons.FaClinicMedical className='me-3' />Inicio</NavLink>
                </li>
                <li className={styleNavL.navIl}>
                    <NavLink to='/propietario-mascota' className='px-1 w-100 d-inline-bock py-2'><FaIcons.FaFolderOpen className='me-3' />Propietario / Mascota</NavLink>
                </li>
                <li className={styleNavL.navIl}>
                    <NavLink to='/citas' className='px-1 w-100 d-inline-bock py-2'><FaIcons.FaBookMedical className='me-3' />Citas</NavLink>
                </li>
                <li className={styleNavL.navIl}>
